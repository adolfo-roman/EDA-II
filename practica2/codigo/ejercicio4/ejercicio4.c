    ...
    for(int k = 0; k < 3; k++)
    {
        for(int a = 0; a < 5; a++)
        {
            ...
            for(int j = 0; j < 6; j++)
            {
                ...
                {
                    case 1:
                        printf("Tipo: Ascendente, Elementos: %d", n);
                        ...
                        break;
                    case 2:
                        printf("Tipo: Descendente, Elementos: %d", n);
                    ...
                    case 4:
                        printf("-- Quick Sort --\n");
                        printf("Big O: Worst case: n^2, Best case: nlog(n)\n");
                        quickSort(arr, 0, n- 1, ptrcount);
                        printf("Corriendo...\n");
                        printf("Total: %d\n", count);
                        //printArray(arr, n);
                        break;
                    case 5:
                        printf("-- Bubble Sort --\n");
                        printf("Big O: Worst case: n^2, Best case: n\n");
                        bubbleSort(arr, n, ptrcount);
                        printf("Corriendo...\n");
                        printf("Total: %d\n", count);
                        //printArray(arr, n);
                        break;
